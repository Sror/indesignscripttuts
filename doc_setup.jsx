...
//Adds page numbers to master pages
var myMasterSpread = myDocument.masterSpreads.item(0);
...
//Adds text frames to master
// var myLeftPage = myMasterSpread.pages.item(0);
// var myRightPage = myMasterSpread.pages.item(1);
var myLeftTextFrame = myLeftPage.textFrames.add();
myLeftTextFrame.geometricBounds = [70, 70, 714, 528];

var myLeftTextFramePreferences = myLeftTextFrame.textFramePreferences;
myLeftTextFramePreferences.firstBaselineOffset = FirstBaseline.leadingOffset;
myLeftTextFramePreferences.textColumnCount = 3;
myLeftTextFramePreferences.textColumnGutter = 14;
...
var myRightTextFramePreferences = myRightTextFrame.textFramePreferences
myRightTextFramePreferences.firstBaselineOffset = FirstBaseline.leadingOffset;
myRightTextFramePreferences.textColumnCount = 3;
myRightTextFramePreferences.textColumnGutter = 14;
